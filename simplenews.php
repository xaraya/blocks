...
class SimplenewsBlock extends BasicBlock implements iBlock
{
    protected $type = 'simplenews';
    protected $text_type = 'Publication Simple News Ticker';
    protected $text_type_long = 'Simple News Ticker for Publications module';
